...
class DExplorer:
    """
    DExplorer class is responsible for loading a pre-trained model and using it to perform inference on input images.
    It detects certain objects in the image by applying a custom detection algorithm and then returns the bounding box
    coordinates along with the associated confidence scores for the detected objects.
    """
